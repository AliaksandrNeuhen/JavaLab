	...
	function checkCancel(form){
		var newTitleValue = document.getElementById("textedittitle").value;
		var newDateValue = document.getElementById("texteditdate").value;
		var newBriefValue = document.getElementById("textareaeditbrief").value;
		var newContentValue = document.getElementById("textareaeditcontent").value;
