package com.epam.testappview.backingbean;
...
import com.epam.testappservice.service.impl.FetchByIdException;
import com.epam.testappservice.service.impl.INewsService;
import com.epam.testappservice.service.impl.ServiceException;
import com.epam.testappview.service.RemoteNewsService;
import com.epam.testappview.util.TypeChecker;
...
public class NewsController implements Serializable{
	...
	public NewsController() throws MalformedURLException {
		newsService = RemoteNewsService.getNewsService();
	}
