 ...
 * generated in the com.epam.testapp.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _RemoveResponse_QNAME = new QName("http://service.testapp.epam.com/", "removeResponse");
    private final static QName _SaveResponse_QNAME = new QName("http://service.testapp.epam.com/", "saveResponse");
    private final static QName _Remove_QNAME = new QName("http://service.testapp.epam.com/", "remove");
    private final static QName _Save_QNAME = new QName("http://service.testapp.epam.com/", "save");
    private final static QName _FetchByIDResponse_QNAME = new QName("http://service.testapp.epam.com/", "fetchByIDResponse");
    private final static QName _ServiceException_QNAME = new QName("http://service.testapp.epam.com/", "ServiceException");
    private final static QName _FetchByIdException_QNAME = new QName("http://service.testapp.epam.com/", "FetchByIdException");
    private final static QName _FetchByID_QNAME = new QName("http://service.testapp.epam.com/", "fetchByID");
    private final static QName _GetList_QNAME = new QName("http://service.testapp.epam.com/", "getList");
    private final static QName _GetListResponse_QNAME = new QName("http://service.testapp.epam.com/", "getListResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.epam.testapp.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "removeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "saveResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "remove")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "save")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "fetchByIDResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "ServiceException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "FetchByIdException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "fetchByID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "getList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testapp.epam.com/", name = "getListResponse")
