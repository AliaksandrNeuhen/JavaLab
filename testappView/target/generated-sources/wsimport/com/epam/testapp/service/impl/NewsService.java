 ...
 * 
 */
@WebServiceClient(name = "newsService", targetNamespace = "http://impl.service.testapp.epam.com/", wsdlLocation = "http://localhost:1710/newsService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWSSERVICE_QNAME = new QName("http://impl.service.testapp.epam.com/", "newsService");
    ...
    public INewsService getNewsServicePort() {
        return super.getPort(new QName("http://impl.service.testapp.epam.com/", "NewsServicePort"), INewsService.class);
    }
    ...
    public INewsService getNewsServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.testapp.epam.com/", "NewsServicePort"), INewsService.class, features);
    }
